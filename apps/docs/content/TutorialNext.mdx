...
<FileBlock filename="instrumentation.ts">
```typescript
...
<FileBlock filename="next.config.js">
```javascript
...
<FileBlock filename="app/error.tsx">
```typescript
'use client'
...
<FileBlock filename="app/api/test-error/route.ts">
```typescript
